...
const EducationCard = () => {
    return (
        <div className='h-full flex flex-col lg:gap-10'>

            <div className=' text-7xl text-center text-yellow-300 my-10'>Education</div>

            <div className=' flex flex-col lg:flex-row gap-12  mx-6'>
                
                <div className='border border-stone-400 w-full md:w-1/2 h-auto p-3 rounded-2xl shadow-2xl  shadow-black text-center' >
                    <div className=' text-2xl  border w-fit p-1 mb-4'><b>Undergraduation</b> (ongoing)</div>
